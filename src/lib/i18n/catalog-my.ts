...
export const my: Catalog<typeof en> = {
  ...
  destinations: {
    ...
    countToExplore_one: "လေ့လာရန် နေရာ {{count}} ခု",
    countToExplore_other: "လေ့လာရန် နေရာ {{count}} ခု",
  ...
  generation: {
    ...
    crafting: "သင့်အတွက် ခရီးစဉ် ရေးဆွဲနေပါသည်…",
    craftingTime: "ပုံမှန်အားဖြင့် စက္ကန့် 30-60 ခန့် ကြာပါသည်။",
  ...
  signUp: {
    ...
    verifyBody: "ဂဏန်း 6 လုံးကုဒ်ကို ပို့ထားပါသည်",
    verifyEmail: "အီးမေးလ် အတည်ပြုမည်",
    fullName: "အမည်အပြည့်အစုံ",
    fullNamePlaceholder: "ဦးဘဘ",
    passwordPlaceholder: "အနည်းဆုံး 8 လုံး",
    ...
    fullNameTooShort: "အမည်သည် အနည်းဆုံး 3 လုံး ရှိရမည်။",
    passwordTooShort: "အနည်းဆုံး 8 လုံး အသုံးပြုပါ။",
  ...
  signIn: {
    ...
    confirmBody: "ဤစက်ပစ္စည်းသည် အသစ်ဖြစ်သဖြင့် ဂဏန်း 6 လုံးကုဒ်ကို ပို့ထားပါသည်",
